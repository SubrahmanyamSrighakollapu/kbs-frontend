...
import { technologiesData } from "@/data/services";
import { 
  Code2, 
  Layers, 
  Server, 
      ...
      <div className="max-w-[1340px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 text-center">
          ...
          <h3 className="text-xl sm:text-2xl font-bold text-slate-800 tracking-tight mt-1">
            Built with Enterprise Tech Stacks
          </h3>
        </div>

        {/* Tech Logos Horizontal Strip */}
        <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 lg:gap-6">
          {technologiesData.map((tech) => {
            ...
            return (
              <div
                key={tech.id}
                className="group flex items-center gap-2.5 rounded-full border border-slate-200 bg-white px-5 py-2.5 text-sm font-semibold text-slate-800 shadow-xs transition-all duration-300 hover:-translate-y-1 hover:border-[#E52B2F]/40 hover:shadow-md hover:text-[#E52B2F]"
              >
                <IconComp 

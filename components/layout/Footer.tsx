...
export default function Footer() {
  return (
    <footer className="bg-[#03142B] text-white pt-16 lg:pt-20 pb-10 border-t border-[#82A0FF]/15">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="flex items-center space-x-3 pt-2">
              <a
                ...
                rel="noreferrer"
                aria-label="LinkedIn"
                className="w-9 h-9 rounded-full bg-[#061A36] border border-[#82A0FF]/20 flex items-center justify-center text-slate-400 hover:text-white hover:border-[#168BFF] hover:bg-[#168BFF] transition-all duration-300"
              >
            ...
            <ul className="space-y-2.5">
              {footerLinks.company.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="text-xs sm:text-sm text-slate-400 hover:text-[#168BFF] transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
